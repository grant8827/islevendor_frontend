    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <div className="max-w-lg mx-auto px-4 py-20 text-center">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-5 mb-6">
          <span className="block text-[11px] font-semibold text-slate-400 uppercase tracking-wider mb-1">Your reference ID</span>
          <span className="block text-xl font-black text-amazon-navy tracking-wide">{referenceId}</span>
        </div>
